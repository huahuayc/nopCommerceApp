...
class SearchCustomer:
    ...
    txtLasstName_id = "SearchLastName"
    ...
    def setLastName(self, lname):
        self.driver.find_element(By.ID, self.txtLasstName_id).clear()
        self.driver.find_element(By.ID, self.txtLasstName_id).send_keys(lname)
